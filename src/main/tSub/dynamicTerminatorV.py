        ...
        if obs_mode:
            ...
            for d_file in sorted(os.listdir(t.d_dir_path)):
                ...
                for row in reader:
                    ...
                    if t.c_time > next_dd_date:
                        ...
                        DD.call_obs(method_code, w.ex_cw_v(), w.ex_pw_v(), threshold, t.c_time, t.o_dir_path, k)
            ...
            for d_file in sorted(os.listdir(t.d_dir_path)):
                ...
                for row in reader:
                    ...
                    if t.c_time > next_dd_date:
                        print(f'call_dd : {t.c_time}')
                        if DD.call(method_code, w.ex_cw_v(), w.ex_pw_v(), threshold, k):
