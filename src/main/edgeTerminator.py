...
from main import driftDetector, featuresExtractor, modelSender, modelTrainer, trafficServer, modelCreator
...
async def main():
    ...
    results = pd.DataFrame(columns=["flow_featured_time", "training_time", "benign_count", "malicious_count"])
