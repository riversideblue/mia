...
key = ("20220215165007276936","192.168.10.5","169.197.141.136")

print(flow[key])
delete_key_list = [
    key for key in flow
    if key[0] == "20220215165007276936"
]
