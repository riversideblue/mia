...
# --- 入力パスと設定
dir_path1 = "/mnt/nas0/g005/murasemaru/exp/1_DataAnalytics/drift/filtered_22020110-22020114/2201HP/2201UkSouth"
dir_path2 = "/mnt/nas0/g005/murasemaru/exp/1_DataAnalytics/drift/filtered_22020110-22020114/2201Lab02"
...
common_path = os.path.commonpath([dir_path1, dir_path2])
...
# ファイル処理
files1 = {fi for fi in os.listdir(dir_path1) if fi.endswith('.csv')}
files2 = {fi for fi in os.listdir(dir_path2) if fi.endswith('.csv')}
common_files = files1 & files2

for fi in common_files:
    fi_path1 = os.path.join(dir_path1, fi)
    fi_path2 = os.path.join(dir_path2, fi)
