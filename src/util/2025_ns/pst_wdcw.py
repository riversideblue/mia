...
# window間距離に対する影響評価描画用スクリプト（パワポ資料用）：現在ウィンドウサイズcwnd
dir_path_dict = {
    "cwnd=300": "/mnt/nas0/g005/murasemaru/exp/2_DriftDetection/euc_k8/c300p3600",
    "cwnd=600": "/mnt/nas0/g005/murasemaru/exp/2_DriftDetection/euc_k8/c600p3600",
    "cwnd=1200": "/mnt/nas0/g005/murasemaru/exp/2_DriftDetection/euc_k8/c1200p3600",
    "cwnd=2400": "/mnt/nas0/g005/murasemaru/exp/2_DriftDetection/euc_k8/c2400p3600",
    "cwnd=3600": "/mnt/nas0/g005/murasemaru/exp/2_DriftDetection/euc_k8/c3600p3600",
}
...
if dfs:
    ...
    plt.legend(fontsize=legend_size,ncol=5,loc="upper left",bbox_to_anchor=(0,1.15))
    plt.grid(True)
    plt.tight_layout()
