...
# プロットするデータ
current_points = [
    (0.25249593, 1.54140857, 0.00995917), #1
    (0.65087773, 1.22789779, -0.10376296), #2
    (0.50964872, -0.30561939, 0.83686038) #3
]
...
past_points = [
    ...
    (0.50207219, -0.43025866, -0.04522768) #5
]

# 保存先
output_path = '/mnt/nas0/g005/murasemaru/exp/other'
file_name = 'dd_method1.png'
